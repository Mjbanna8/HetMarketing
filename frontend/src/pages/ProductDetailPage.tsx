      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div>
          <div
            ...
            className="flex overflow-x-auto snap-x snap-mandatory rounded-2xl bg-surface-50 mb-4 [&::-webkit-scrollbar]:hidden min-h-[300px] [-ms-overflow-style:none] [scrollbar-width:none]"
          >
            {sortedImages.length > 0 ? (
              sortedImages.map((img, i) => (
                <div
                  key={img.id}
                  className="shrink-0 w-full aspect-square snap-center cursor-zoom-in"
                  onClick={() => {
                    setSelectedImage(i);
                    setZoomOpen(true);
                  }}
              ...
              <div className="shrink-0 w-full aspect-square snap-center flex items-center justify-center text-surface-300">
